		...
		<div className='App'>
			...
			<div className='keyboard-container'>
				...
				<div className='key-row'>
					...
					{/* i tried using the keycode for  backspace which is '8' and converting it to a string but that just prints out an empty string instead of deleting the previous entry */}
					{/* also tried using the escape sequence '\b' and it just printed that out instead */}
					<button className='btn-large' value={String.fromCharCode(8)} onClick={buttonHandler}>Backspace</button>
					{/* i think its supposed to be a loop or a new function entirely, but it's late and i'm tired */}
				</div>
				<div className='key-row'>
